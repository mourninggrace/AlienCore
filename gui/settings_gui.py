...
class SettingsWindow:
    ...
    def _tab_display(self):
        ...
        self._opt(t, "sensors.nvme_temp",   "Primary NVMe temp",            "Via LibreHardwareMonitor")
        self._opt(t, "sensors.nvme_temp2",  "Second NVMe temp",             "Auto-hidden if no second NVMe is installed")
        self._opt(t, "sensors.nvme_temp3",  "Third NVMe temp",              "Auto-hidden if no third NVMe is installed")
        self._opt(t, "sensors.nvme_temp4",  "Fourth NVMe temp",             "Auto-hidden if no fourth NVMe is installed")
        self._opt(t, "sensors.ssd_temp",    "Primary SATA SSD temp",        "Auto-hidden if no SATA SSD is installed")
        self._opt(t, "sensors.ssd_temp2",   "Second SATA SSD temp",         "Auto-hidden if not present")
        self._opt(t, "sensors.ssd_temp3",   "Third SATA SSD temp",          "Auto-hidden if not present")
        self._opt(t, "sensors.ssd_temp4",   "Fourth SATA SSD temp",         "Auto-hidden if not present")
        self._opt(t, "sensors.hdd_temp",    "Primary HDD temp",             "Auto-hidden if no HDD is installed")
        self._opt(t, "sensors.hdd_temp2",   "Second HDD temp",              "Auto-hidden if not present")
